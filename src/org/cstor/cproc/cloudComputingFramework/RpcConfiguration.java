 ...
 */
  ...
  public class RpcConfiguration extends Configuration {
	  private static final Log LOG = LogFactory.getLog(RpcConfiguration.class.getName());
	 
	  private static RpcConfiguration rpcConfiguration = null;	  
	  
	  private RpcConfiguration() {
	    super(true);
	  }
	  
	public static RpcConfiguration getRpcConfiguration(){
